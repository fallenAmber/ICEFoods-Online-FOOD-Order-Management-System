<footer class="bg-dark text-light link-light p-5">
  <div class="container-md">
    <div class="row">
      <div class="col">
        <h4>ICEFoods</h4>
        <p>
          +8801734760070, +8801796413992, +8801518424941<br>
          icefoods@gmail.com<br>
          Dr. MA Wazed Mia Academic Building, Rajshahi-6205, Bangladesh
        </p>
      </div>
